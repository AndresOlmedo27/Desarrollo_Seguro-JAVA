...
public void readNumber(){
    ...
    DecimalFormat df = new DecimalFormat("#.00"); // objeto "DecimalFormat" para limitar número de decimales a 2

    System.out.println("El "+ porIVA+ "% de " +numero + " es " +df.format(ivaTotal)+" euros, así que el precio total de la factura es de " +df.format(precioTotal)+" euros.");
